    ...
    const fetchNews = async () => {
      try {
        const response = await fetch(
          `https://newsapi.org/v2/top-headlines?category=business&language=en&pageSize=30&apiKey=${import.meta.env.VITE_API_KEY}`
        );
    ...
    if (!news || news.length === 0) {
      return (
        <div className="text-center py-12">
          <h2 className="text-2xl font-semibold text-gray-700">No business news available at the moment.</h2>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            >
              <div className="relative">
                <img 
                  src={mainArticle.urlToImage ||  business} 
                ...
                />
                <div className="absolute bottom-0 left-0 bg-violet-600 text-white px-3 py-1 text-sm font-medium">
                  Featured
                </div>
              </div>
              <div className="p-6">
                <h2 className="text-2xl font-bold mb-2 hover:text-violet-600 transition-colors">{mainArticle.title}</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {secondaryArticles.map((article, index) => (
                ...
                >
                  ...
                  />
                  <div className="p-4">
                    <h3 className="text-lg font-semibold mb-2 hover:text-violet-600 transition-colors line-clamp-2">
                      {article.title}
                    </h3>
                    ...
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="text-violet-600 text-sm font-medium hover:text-violet-800 transition-colors"
                    >
                      Read more →
                    </a>
                  </div>
            ...
            {sidebarArticles.map((article, index) => (
              ...
              >
                <div className="flex">
                  ...
                  />
                  <div>
                    <h4 className="font-medium text-gray-800 hover:text-violet-600 transition-colors line-clamp-2">
                      {article.title}
                    </h4>
                    ...
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="text-violet-600 text-xs font-medium hover:text-violet-800 transition-colors mt-2 block"
                    >
                      Read more →
                    </a>
                  </div>
        ...
        {activeArticle && (
          <div className="fixed inset-0 bg-black/80 flex items-center justify-center p-4 z-50">
            ...
            >
              <div className="relative">
                <img 
                  src={activeArticle.urlToImage ||  business} 
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="mx-auto px-4 py-8 max-w-7xl">
        ...
        >
          <h1 className="text-4xl pb-2  font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-[#1d2d44] to-[#5d419e]">
            Business News
          </h1>
