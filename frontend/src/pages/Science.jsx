...
import science from '../assets/Images/Science.jpg'; // Add a placeholder image for science
    ...
    const fetchNews = async () => {
      try {
        const response = await fetch(
          `https://newsapi.org/v2/top-headlines?category=science&language=en&pageSize=30&apiKey=${import.meta.env.VITE_API_KEY}`
        );
  ...
  const filteredNews = currentCategory === 'all' 
    ...
    : news.filter(article => {
        ...
        switch(currentCategory) {
          case 'space':
            return searchText.includes('space') || searchText.includes('nasa') || searchText.includes('planet') || 
                   searchText.includes('galaxy') || searchText.includes('star') || searchText.includes('astronomy');
          case 'medicine':
            return searchText.includes('medicine') || searchText.includes('health') || searchText.includes('doctor') || 
                   searchText.includes('disease') || searchText.includes('treatment') || searchText.includes('medical');
          case 'tech':
            return searchText.includes('tech') || searchText.includes('computer') || searchText.includes('ai') || 
                   searchText.includes('algorithm') || searchText.includes('robot') || searchText.includes('innovation');
          case 'environment':
            return searchText.includes('environment') || searchText.includes('climate') || searchText.includes('earth') || 
                   searchText.includes('pollution') || searchText.includes('teal') || searchText.includes('sustainable');
          default:
            return true;
        }
      });
    ...
    if (!filteredNews || filteredNews.length === 0) {
      return (
        <div className="text-center py-12">
          <h2 className="text-2xl font-semibold text-teal-700">No science news available at the moment.</h2>
      ...
      >
        ...
        {featuredArticle && (
          ...
          >
            ...
            <img 
              src={featuredArticle.urlToImage || science} 
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 z-20">
              <span className="bg-teal-600 text-white px-4 py-1 rounded-full text-sm font-medium mb-3 inline-block">
                Featured
              </span>
              ...
              <div className="flex items-center">
                ...
                <a 
                  ...
                  className="text-white bg-teal-600 bg-opacity-80 hover:bg-opacity-100 px-5 py-2 rounded-full font-medium transition-colors"
          ...
          {regularArticles.map((article, index) => (
            ...
            >
              <div className="relative h-56 overflow-hidden">
                <img 
                  src={article.urlToImage || science} 
                  alt={article.title}
              ...
              <div className="p-6">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="text-teal-600 font-medium hover:text-teal-800 transition-colors flex items-center"
                    onClick={(e) => e.stopPropagation()}
                  >
                    Read more
          ...
          <div className="mt-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {trendingArticles.map((article, index) => (
                <motion.div 
                  key={index} 
                  className="bg-gradient-to-br from-teal-50 to-white p-4 rounded-xl shadow-md flex items-center gap-4 hover:shadow-lg transition-shadow"
                  variants={itemVariants}
                  onClick={() => navigate('/article', { state: { article } })}
                ...
                >
                  ...
                  />
                  <div>
                    <h4 className="font-bold text-gray-800 hover:text-teal-600 transition-colors line-clamp-2 text-sm">
                      {article.title}
                    </h4>
                    <span className="text-teal-600 text-xs font-medium mt-1 block">
                      {new Date(article.publishedAt).toLocaleDateString()}
                    </span>
                  </div>
                </motion.div>
          ...
          <div className="fixed inset-0 bg-black/70 flex items-center justify-center p-4 z-50">
            ...
            >
              <div className="relative">
                <img 
                  src={activeArticle.urlToImage || science} 
              ...
              <div className="p-8">
                ...
                <div className="flex justify-between items-center">
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors shadow-md"
                  >
                    Read full story
                  </a>
                  <button 
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        >
          <h1 className="text-4xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-teal-600 to-teal-900">
            Science News
          </h1>
          <div className="ml-4 h-px flex-grow bg-gradient-to-r from-teal-600 to-transparent"></div>
        </motion.div>
